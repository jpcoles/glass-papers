...
% \citet{2004ApJ...606...67H}: Red-Sequence Cluster Survey (RCS); No split of galaxy sample in red & blue (magnitude-selected); Not taking care of systematics; f=0.77 --> probably good alignment, maybe haloes somewhat rounder
...
\end{equation}
% \begin{equation}
%   L(x) = \mathrm{ln}\left(\frac{x}{\sqrt{c^2+x^2}+c}\right).
% \end{equation}
