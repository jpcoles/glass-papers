...
% "Light versus dark matter in strong-lens galaxies: Dark matter halos may be rounder than their stellar distributions"
...
\cb{We employ a shape definition related to the definition used by \cite{2014arXiv1401.7990C}. The ellipticity parameter $e$ is defined as} %the ratio of the two eigenvalues $\lambda_2$ and $\lambda_1$, i.e.
