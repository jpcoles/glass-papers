...
% Our best-fit value for the ellipticity of the surface mass density is 0.24, which translates to an axis ratio of 0.78. We rule out the hypothesis of no ellipticity at the 4σ confidence level, and ellipticity < 0.12 (axis ratio > 0.89) at the 2σ level. --> significant detection around LRG with SDSS data
