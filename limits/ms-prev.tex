...
\caption{The effect of changing the grid resolution, pixrad. From top to bottom, the panels show results for a single quad without time delays, but with stellar mass constraints using pixrad$\,\, = 10,7,6,5$, respectively. We use 8 normally.}
