...
\hline
DMdom/DMshallow & 1 & 4 & 0.05 & $11^{2.95}$ & 50 kpc\\ % AA
DMdom/DMcuspy & 1 & 4 & 1 & $11^2$ & 50 kpc \\ % AC
Sdom/DMshallow & 1.5 & $2^{1.5}$ & 0.16 & $11^{2.84}$ & 50 kpc \\ % BB
Sdom/DMcuspy & 1.5 & $2^{1.5}$ & 1 & $11^2$ & 10 kpc %BC
\end{tabular}
...
\begin{figure*}
\includegraphics[width=0.49\textwidth]{BCZContrastR1R3_TmS_sigp_beta.pdf}
\includegraphics[width=0.49\textwidth]{BCQuadR1a_TmS_sigp_beta.pdf}
