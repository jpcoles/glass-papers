...
potential}, e.g., $\kappa_n = \kappa_\mathrm{DM} + \kappa_s$ for a two-component model.
...
galaxies \mockAC{} and \mockBC{} where the mass profile is steepest and the reconstruction of
the double is poorest. However, the addition of an arc is sufficient to correct
this.

\hilight{Write about the shape plot and how we measured shape.}
...
\eqnrefp{eqn:sphericaljeans} for two \mockBC{} models ZContrastR1R3
(\textbf{left}) and QuadR1a (\textbf{middle}) assuming an anisotropy $\beta=0$
...
\eqnrefp{eqn:virialaverage} as a function of the upper limit of the averaging
...
\hilight{This paragraph should go.}
