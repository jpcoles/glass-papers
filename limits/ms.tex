...
\item In free-form models, there is no specified parametric form for
  ...
  extra images are produced.  Free-form are at present most common for
  cluster lenses\citep{2009ApJ...690..154S,2013arXiv1304.2393S}.
...
\begin{equation}
  ...
  \frac{\theta_E}{4\pi} \frac{D_S}{D_{LS}}
\end{equation}
...
single lens.  Some models have attempted this, starting from a prior
based on the values and uncertainties from CMB fluctuations
\citep{2010Sci...329..924J,2013arXiv1306.4732S}, but tests using
simulated lenses are desirable.
