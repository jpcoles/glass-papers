...
central image only belongs to the Z1 source to avoid over-constraining the
models (see \secref{sec:lensconfig} for further details). Images of the same colour share a common source. The extended source examples have been constructed so that the images will form arclets.
