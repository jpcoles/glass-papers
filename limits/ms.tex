...
\title[\Glass]{Gravitational Lens Recovery with \Glass: Illustrating the power of non-parametric lens modelling}
\author{%
Jonathan P. Coles 
\and 
Justin I. Read
...
In this paper, we present a new non-parametric strong lens modelling framework \Glass\ that builds on an earlier code \PixeLens\ \citep{1997MNRAS.292..148S,2008ApJ...679...17C}. Like \PixeLens, we use a grid of mass pixels to model the lens, searching through many models consistent with the data to marginalise over model uncertainties. However, \Glass\ improves on \PixeLens\ in a number of important respects:
