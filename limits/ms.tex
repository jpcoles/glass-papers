...
\end{equation}
%
which accounts for the gravitational lensing effect of an intervening mass \citep[e.g.][]{1992grle.book.....S}. For
...
\end{equation}
%
where $\theta_E^2 = \frac{D_{LS}}{D_S D_L} \frac{4 GM}{c^2}$ is the Einstein radius. 
