...
\item {\bf Model ensembles:} Model ensembles, exploring a diverse range of
    ...
    parametric models \citep{1999AJ....118...14B} but are more common in
...
models to impose further priors that may be difficult to enforce during the
...
For our current analysis, we do not exclude any models.
...
difference between generating 1,000 or 10,000 models. For our problems, the
typical ``warm-up'' time was about 4s, and the modelling time was 20s using a
parallel shared-memory machine with 40 cores.
