...
\item Change variable $\chi$ to something else ($f$?) to avoid
  confusion with $\chi^2$.

\item Correct equation \eqref{badness} to describe what is actually
  calculated.

\item Show results for $1\sigma$ and $2\sigma$ rather than full
  \Glass\ ensemble.
