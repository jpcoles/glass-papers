...
\item {\bf Free-form modelling:} In `free-form' or non-parametric
  ...
  degeneracies rather than find a single `best-fit'
  ...
  time-delay galaxy lenses, parametric models have historically led to
  tension with independent measures of the Hubble parameter $H_0$
...
\item Model ensembles, exploring a diverse
...
\item {\bf Stellar kinematic constraints:} This was first suggested by
  ...
  degeneracies. This works because stellar kinematics can provide an
...
\end{equation}
%
where $\langle v^2_\mathrm{los}\rangle$ is the projected stellar
velocity dispersion, and the above relation becomes exact for
isothermal lenses.  The technique has been applied to many lenses
\citep{2006ApJ...649..599K,2008ApJ...682..964B}.  Going further, the
