...
\hline
DM-ctr,DM-core & 1 & 4 & 0.05 & $11^{2.95}$ & 50 kpc\\ % AA
DM-ctr,DM-cusp & 1 & 4 & 1 & $11^2$ & 50 kpc \\ % AC
S-ctr,DMcore & 1.5 & $2^{1.5}$ & 0.16 & $11^{2.84}$ & 50 kpc \\ % BB
S-ctr,DMcusp & 1.5 & $2^{1.5}$ & 1 & $11^2$ & 10 kpc %BC
\end{tabular}
...
\begin{figure*}
\includegraphics[width=0.49\textwidth]{BC_beta.pdf}
