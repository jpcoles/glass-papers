...
\item Change variable chi to something else ($f$?) to avoid confusion
  with $\chi^2$.

\item Replace equation 20 with what you are actually doing when
  calculating $chi$ (now $f$).

\item Add plot of $chi$ ($f$) for $lambda_1/lambda_2$ and theta shape
  parameters (c.f. what Claudio is doing).
