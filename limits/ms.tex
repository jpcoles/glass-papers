...
\item {\bf Model ensembles:} Model ensembles, exploring a diverse range of
    ...
    and more recently with the Hubble Frontier Fields initiative
    \citep[e.g.,][]{}, but are more common in
    free-form models, where -- since such models are deliberately
...
since a negative azimuthally averaged density slope would be unstable
